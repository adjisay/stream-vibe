class OverlayMenu {
  ...
  constructor() {
    ...
    this.burgerButtonEllement = this.rootElement.querySelector(
  ...
  onBurgerButtonClick = () => {
    this.burgerButtonEllement.classList.toggle(this.stateClasses.isActive)
    this.dialogElement.open = !this.dialogElement.open
    document.documentElement.classList.toggle(this.stateClasses.isLock)
  }

  bindEvents() {
    this.burgerButtonEllement.addEventListener(
      "click",
